    ...
    <div class="max-w-4xl mx-auto py-10 px-4">
        <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
            <div class="flex items-center gap-3 mb-8 border-b-2 border-[#199CA4] pb-4">
                ...
                <h1 class="text-xl font-bold text-gray-900">Edit Pet</h1>
            </div>
            ...
            <form action="{{ route('pets.update', $pet) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-8">
                    ...
                    <div class="relative border-2 border-dashed border-gray-200 hover:border-[#199CA4] rounded-2xl p-6 text-center transition bg-gray-50/50">
                        ...
                        <span class="text-sm text-gray-600 block font-medium mb-1">Choose a high-quality photo to replace existing</span>
                    ...
                    @if($pet->photo_path)
                        ...
                        <div class="w-28 h-28 mt-2 rounded-xl overflow-hidden border">
                            <img src="{{ asset('storage/'.$pet->photo_path) }}" class="w-full h-full object-cover">
                        </div>
                    @endif
                </div>
                ...
                <div class="flex items-center gap-3 justify-end border-t border-gray-100 pt-6">
                    ...
                    <button type="submit" 
                        class="px-6 py-2.5 bg-[#199CA4] text-white text-sm font-semibold rounded-xl hover:bg-[#13787F] shadow-md shadow-[#199CA4]/10 transition">Update Pet Profile</button>
                </div>
            </form>
        </div>
    </div>
